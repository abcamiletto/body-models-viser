...
SOMA, and GarmentMeasurements models. The Rust implementation is checked against
Python `body-models` output using JSON fixtures, and the Python wheel ships the
